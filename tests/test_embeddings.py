...
from src.project_watch_mcp.utils.embedding import (
    EmbeddingsProvider,
...
class TestMockEmbeddingsProvider:
    ...
    async def test_mock_embed_text(self):
        ...
        provider = MockEmbeddingsProvider(dimension=384)
    ...
    async def test_mock_embed_batch(self):
        ...
        provider = MockEmbeddingsProvider(dimension=256)
    ...
    def test_mock_dimension_property(self):
        ...
        provider = MockEmbeddingsProvider(dimension=512)
