...
class TestOpenAIIntegration:
    ...
    async def test_openai_semantic_similarity(self):
        ...
        assert sim_similar > 0.65  # Similar sentences typically > 0.65 (adjusted for model variance)
    ...
    async def test_openai_code_embeddings(self):
        ...
        assert sim_functions > 0.55  # Similar functions (adjusted for model variance)
