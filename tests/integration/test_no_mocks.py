...
def test_no_mocks_in_production():
    ...
    Note: TestEmbeddingsProvider is an intentional development/testing tool,
    ...
    allowed_exceptions = {
        "utils/embedding.py": ["TestEmbeddingsProvider", "mock embeddings", '"mock"', "== 'mock'", '== "mock"'],  # Development embedding provider
